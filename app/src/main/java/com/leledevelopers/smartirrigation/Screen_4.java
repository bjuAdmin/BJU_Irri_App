...
public class Screen_4 extends SmsServices {
    ...
    Button settings, configureFieldIrrigation, configureFieldFertigation, configurePumpFiltration, sendServiceSMS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configurePumpFiltration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                status.setText("Configure Water Filtration");
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
        ...
        sendServiceSMS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                status.setText("Display Configured Data");
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void initViews() {
        ...
        sendServiceSMS = findViewById(R.id.screen_4_button4);
